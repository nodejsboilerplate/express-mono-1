...
interface UserInputValidatorsType {
    ...
    createUserAddressInput(payload: CreateUserAddressInputType): CreateUserAddressInputType | z.ZodError
    ...
    updateUserPhoneInput(payload: UpdatePhoneInputType): UpdatePhoneInputType | z.ZodError
    updateUserEmailInput(payload: UpdateEmailInputType): UpdateEmailInputType | z.ZodError
...
export class UserInputValidators implements UserInputValidatorsType {
    idInput(payload: IdInputType): IdInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.id);
    ...
    updateUserCoreInput(payload: UpdateUserInputType): UpdateUserInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updateUser);
    ...
    updateUserProfileInput(payload: UpdateProfileInputType): UpdateProfileInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updateProfile);
    ...
    updateUserPhoneInput(payload: UpdatePhoneInputType): UpdatePhoneInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updatePhone);
    ...
    updateUserEmailInput(payload: UpdateEmailInputType): UpdateEmailInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updateEmail);
    ...
    updateUserAddressInput(payload: UpdateAddressInputType): UpdateAddressInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updateAddress);
    ...
    updateUserContactInput(payload: UpdateContactInputType): UpdateContactInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.updateContact);
    ...
    deleteByUserIdWithContextIdInput(payload: DeleteByUserWithContextIdInputType): DeleteByUserWithContextIdInputType | z.ZodError {
        const {
            ...
            success,
            error,
        } = validateWithZod(payload, UserZSchema.deleteByUserWithContextId);
